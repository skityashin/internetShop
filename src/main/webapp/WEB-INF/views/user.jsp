...
<div class="registration_common_block">
    <form action="#" method="post" class="rf">
        <div class="rid-line">
            ...
            <div class="rid-line__content">
                <div class="rid-line__input rid-line__input_profile-edit">
                    <input type="text" name="typeInName" class="g-rid-input" id="typeInName" placeholder="Введите Имя">
                </div>
            </div>
            <div class="rid-line__tip">
                <div class="rid-line__tip-content">
                    <div class="rid-line__tip-line" id="Name1" style="display:none">Поле должно быть заполненным</div>
        ...
        <div class="rid-line">
            ...
            <div class="rid-line__tip">
                <div class="rid-line__tip-content">
                    <div class="rid-line__tip-line" style="display:none" id="Name3">Поле должно быть заполненным</div>
        ...
        <div class="rid-line">
            <label for="birthDate" class="rid-line__label rid-line__label_wide">
            ...
            <div class="rid-line__tip">
                <div class="rid-line__tip-content">
                    <div class="rid-line__tip-line" style="display:none" id="Name13">Укажите дату рождения полностью</div>
